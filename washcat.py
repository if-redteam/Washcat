...
ap.add_argument("-o", "--output", required=False, help="Name of the output file which should contain the correlated names and cleartext passwords (Default: stdout)")
ap.add_argument("--ntlmv2", required=False, help="Switch: Set job file hash type as NTLMv2 (Default: NTLM)", action='store_true')
